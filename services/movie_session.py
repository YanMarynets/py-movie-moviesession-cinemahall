...
def update_movie_session(
    ...
    session_to_upd = MovieSession.objects.get(id=session_id)
    if show_time:
        session_to_upd.show_time = show_time
    if movie_id:
        session_to_upd.movie_id = movie_id
    if cinema_hall_id:
        session_to_upd.cinema_hall_id = cinema_hall_id
    session_to_upd.save()
